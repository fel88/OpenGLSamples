...
namespace stencil
{
    public class Shader
    {
        ...
        public Shader(string vs, string fs, string gs = null)
        {
            Init(vs, fs, gs, null);
        }
        ...
        protected void Init(string vs, string fs, string gs, Assembly _asm)
        {
            ...
            var geometryShaderSource = ResourceFile.GetFileText(gs, asm);
